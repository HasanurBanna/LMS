  ...
  const features = [
    {
      ...
      coloricon: "bg-[#5B72EE]",
      anima: "slide-bottom-left" as const,
    },
    {
      icon: <FaCalendarAlt />,
    ...
    },
    {
      ...
      coloricon: "bg-[#29B9E7]",
      anima: "slide-bottom-right" as const,
    },
  ];
        ...
        <section className="container text-center">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14 py-20">
            {features.map((feature, index) => (
              <ScrollAnimation animation={feature?.anima} key={index}>
                <div className="relative flex flex-col items-center bg-white p-6 shadow-[0_0_15px_rgba(0,0,0,0.15)] rounded-xl">
                  <div
